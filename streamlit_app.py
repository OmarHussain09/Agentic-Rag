...
# # Initialize vectorstore (run once at startup)
# @st.cache_resource
# def setup_vectorstore():
#     logger.info("Initializing vectorstore for Streamlit app")
#     return initialize_vectorstore()

# # Title and description
# st.title("AI Retrieval-Augmented Generation (RAG) Workflow")
# st.markdown("Enter a question to get an answer powered by a vectorstore or web search. View retrieved documents and grading results below.")
...
#             # Ensure vectorstore is initialized (cached)
#             setup_vectorstore()
